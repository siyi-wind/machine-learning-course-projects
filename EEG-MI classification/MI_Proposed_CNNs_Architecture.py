...
# DataSet Address K:/Google_Driver/EEG_Features_For_Multi_class_Motor_Imagery/EEG_Test_Raw_Data/Changed_Excel_Data/
DIR = 'Data/'

# Model Saver Address K:/Google_Driver/EEG_Features_For_Multi_class_Motor_Imagery/EEG_Test_Raw_Data/First_Try_Model/
SAVE = 'Model/'
...
with tf.name_scope('Convolutional_1'):
    with tf.name_scope('W_conv1'):
        W_conv1 = weight_variable([3, 3, 1, 32])   #[3, 3, 1, 32]
